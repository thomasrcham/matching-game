...
function Game() {
    ...
    //absolute value idea for matched state tracking - duplicate the id as an inverse signed integer and add the two ids together at comparison. if the result is 0, the comparison is a successful match
